...
try {
    ...
    if ((int)$chk->fetchColumn() > 0) {
        $_SESSION['flash_error'] = 'Selected slot is not available. Please choose a different time.';
        header('Location: /workshop-app/public/book.php');
        exit;
    }
    ...
    $_SESSION['flash_success'] = 'Your appointment has been booked successfully!';
